...
OBJECTS= controller.o test.o board.o decorator.o basecell.o cell.o block.o blockL.o blockO.o blockI.o blockS.o blockZ.o blockT.o blockJ.o generation.o level0.o level1.o level2.o level3.o level4.o RAIILevel.o tetris_graphics.o window.o 
EXEC=test
